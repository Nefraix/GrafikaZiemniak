...
void szescian(void)
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
	{
		...
		GLfloat sc[3] = { 50.0f,50.0f,0.0f };
		GLfloat sd[3] = { 0.0f,50.0f,0.0f };
		GLfloat se[3] = { 0.0f,0.0f,-50.0f };
		GLfloat sf[3] = { 50.0f,0.0f,-50.0f };
		GLfloat sg[3] = { 50.0f,50.0f,-50.0f };
		GLfloat sh[3] = { 0.0f,50.0f,-50.0f };
		

		// Sciany skladowe
		//glVertex3f przyjmuje 3 zmiennie zamiast tablicy
		//cos(3.14 / 6) * 50
		//sin(3.14/6)*50
		
		glColor3f(1.0f, 0.0f, 0.0f);
		glBegin(GL_POLYGON);
		glVertex3f(sa[0], sa[1], sa[2]);
		glVertex3f(sb[0], sb[1], sb[2]);
		glVertex3f(sc[0] , sc[1], sc[2]);
		glVertex3f(sd[0] , sd[1] , sd[2]);
		glEnd();
...
void walec(double xStart, double yStart, double zStart, double r, double h)
{
